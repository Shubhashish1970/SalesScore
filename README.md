...
- **API key (GitHub):** Add **`GEMINI_API_KEY`** (or **`GOOGLE_API_KEY`**) as a **GitHub repository secret**: **Settings → Secrets and variables → Actions** → New repository secret. If unset, the app still works; commentary blocks stay empty.
