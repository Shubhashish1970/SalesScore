...
/**
 * Screen 1: One concept — your score and a single-line explanation.
 * CTA directs user to swipe for "why".
 */
interface Props {
  data: ScorecardData;
}
...
export function ScoreOverview({ data }: Props) {
  ...
  return (
    <section className="min-h-[80dvh] flex flex-col justify-center px-5 py-6">
      ...
      <div className="my-6">
        <span className="text-6xl font-bold text-slate-900 tabular-nums">{data.finalScore}</span>
